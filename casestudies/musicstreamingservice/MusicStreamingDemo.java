...
import casestudies.musicstreamingservice.command.NextTrackCommand;
import casestudies.musicstreamingservice.command.PauseCommand;
import casestudies.musicstreamingservice.command.PlayCommand;
import casestudies.musicstreamingservice.entities.*;
...
public class MusicStreamingDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        NextTrackCommand
                next = new NextTrackCommand(player);
